...
class BamlAsyncClient:
    ...
    async def GenerateCoverLetterWithReference(
        self,
...
class BamlStreamClient:
    ...
    def GenerateCoverLetter(
        ...
        user_profile: str,job_description: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.CoverLetterResponse, types.CoverLetterResponse]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      else:
      ...
      return baml_py.BamlStream[partial_types.CoverLetterResponse, types.CoverLetterResponse](
        raw,
